...
\begin{frame}{Differential cross sections --- RHC and combined}
  \begin{columns}[c]
  \column{.5\textwidth}\centering\includegraphics[width=\linewidth]{dsigma_RHCFULL}\\{\scriptsize RHC}
  \column{.5\textwidth}\centering\includegraphics[width=\linewidth]{dsigma_COMB}\\{\scriptsize Combined}
  \end{columns}
\end{frame}

...
\begin{itemize}\itemsep2pt
  \item \textbf{Before the control regions are opened:} ratification of the frozen
    procedure by the conveners; the control-region skim of the beam-on files (signal-region
    events never written), which does not yet exist; the $\pi^0$ definition without the
    final multiplicity cut, whose effect can be quantified with a reprocess of the Monte
    Carlo only.

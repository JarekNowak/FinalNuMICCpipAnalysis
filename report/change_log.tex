...
\subsection{Proton-tagged detector systematics are absent, not merely incomplete}

Of the $51$ current extractions, all $18$ inclusive results carry a detector systematic
and all $33$ proton-tagged results carry none: the \texttt{detVar} column is \texttt{n/a}
for every proton-tagged observable in every configuration.  The quoted proton-tagged
uncertainties are therefore understated by the size of a term that runs between $16.9\%$
and $42.8\%$ in the inclusive results.

This is why the proton-tagged material is presented as secondary scope in the analysis
note, and why no proton-tagged result should be quoted as final until the detector
variations have been propagated through that selection.

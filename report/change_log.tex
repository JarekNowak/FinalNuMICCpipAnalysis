...
the fake-data closure ratios and $\sigma_{\rm int}$ move at the per-cent level (see the
regenerated tables); no covariance changes. The real-data path was never affected.

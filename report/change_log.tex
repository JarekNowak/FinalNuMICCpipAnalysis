...
Adding one cut per control region drives the CC$0\pi$ signal fraction from $8.7\%$ to $2.1\%$ while
keeping $58\%$ of the events and raising the CC$0\pi$ content of the background from $72\%$ to
$85\%$. The data-to-prediction ratio is flat under every far cut ($0.84\to0.85$; $\pi^0$
$0.91\to0.92$), so the $8$--$16\%$ control-region deficit is not signal contamination.
...
rebuilt on it, raising $\sigma_{\rm FHC}$ by $14.0\%$ and $\sigma_{\rm comb}$ by $5.8\%$; RHC and
the fake-data closure are unaffected. \texttt{bkgfit/run1\_trigger.py} is the record of the
evidence.
...
$\theta_p$ bin edges                & $0,\,0.597,\,0.942,\,1.287,\,\pi$ & now the RHC-derived $0,\,0.659,\,1.068,\,1.539,\,\pi$~rad (2026-09-18) \\

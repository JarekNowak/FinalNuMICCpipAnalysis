...
$0.753\to0.658$, $1.05/4\to0.74/5$. The inclusive closure mean moves from $1.018$ to
...
Verified by \texttt{macros/cr\_skim\_check.C} on a Monte Carlo and a beam-off file
...
The following are outstanding as of 2026-09-06. None is a correction awaiting application;
they are prerequisites, limits of the exposure, or tests not yet made. The analysis note's
request and Limitations sections carry the same list.

\begin{itemize}\itemsep2pt
  \item \textbf{Before the control regions are opened:} ratification of the frozen
    procedure by the conveners, including the $\pi^0$ definition in the light of the
    multiplicity-cut comparison now available; independent verification of the
  ...
  \item \textbf{Before the signal region is opened:} confirmation that the flux constants
    ...
    the clean-cache bit-identical reproduction repeated on the 2026-09-06 release; the
    ensemble extended to RHC and to the proton-tagged family; the inverted-proton-PID
    control region for any proton-tagged result.

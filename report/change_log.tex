...
The macro now applies the unified rule and the ensemble is being re-run for $p_\mu$,
$\cos\theta_\mu$ and the one-bin total (SLURM 3277674, 3277691, 3277692); the offset is
stated as partly understood until then.

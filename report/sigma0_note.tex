...
\begin{enumerate}
  ...
  \item \textbf{Add \texttt{shr\_moliere\_avg\_v} to the BDT}
        (Sec.~\ref{sec:photonstudy}) and retrain. Done; see that section for the
        measured separation, which is weak ($\langle S^2\rangle = 0.065$ against
        $0.159$ for shower energy), so little is expected of it.

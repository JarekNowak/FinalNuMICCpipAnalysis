...
\begin{table}[H]
  \centering
  \caption{(``Released'' means the 2026-09-04 release; the forward-split five-bin $\cos\theta_\pi$ row is the binning released since 2026-09-06.) (``Released'' means the 2026-09-04 release; the forward-split five-bin $\cos\theta_\pi$ row is the binning released since 2026-09-06.) Total flux-averaged cross section from the one-bin extraction

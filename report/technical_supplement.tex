...
cut-and-count comparison (Table~\ref{tab:total_xsec}) GENIE went from $1.0\sigma$ to
$0.9\sigma$ below the FHC measurement while NEUT went from $0.8\sigma$ to $1.0\sigma$ above
it, at the uncertainty band then in use; with the current band these read $0.5\sigma$ and
$0.6\sigma$. Had the $p_\pi$ prediction alone been used, the $8\%$ deficit would have appeared as a
...
variations included, 2026-08-31 pass). It closes against the $A_C$-smeared truth, but that
closure cannot restore shape information the response does not contain (the top bin is
$2\%$ diagonal), so these numbers are a check of the machinery and \emph{not} a result;
they were removed from the analysis note's result tables for that reason. The
six-bin generator predictions, rebinned from the earlier three-bin ones with integrals
conserved (GENIE $0.501$, NuWro $0.646$, GiBUU $0.735$, NEUT
...
\midrule
FHC      & $0.523$ & $1.11$ & $0.36/6$ \\
RHC      & $0.437$ & $1.21$ & $1.12/6$ \\
Combined & $0.467$ & $1.10$ & $0.41/6$ \\
\bottomrule
\end{tabular}
\end{center}
...
\noindent\emph{Provenance.} The D'Agostini cross-checks and closure figures of this section
were evaluated on the 2026-08-31 release. They were not re-run after the beam-off
normalisation correction of 2026-09-02 (analysis note, change log), which changed the
Wiener-SVD integrals by at most $2\%$ and cannot change the D'Agostini integrals by more;
the comparison they support, Wiener-SVD spread versus D'Agostini flatness, is unaffected.
...
It agrees with all four generators within $0.7\sigma$: standalone GENIE sits
$0.5$--$0.6\sigma$ low, while GiBUU, NEUT and NuWro lie within $0.7\sigma$. The
uncertainty is now the prediction total of the released $p_\mu$ extraction
(\noteref{Table}{tab:systbreak}), which includes the detector-variation rebuild of
2026-08-31; the previous version of this table used a pre-rebuild breakdown
($25.5/35.7/28.9\%$) and its uncertainties are superseded. The values are those of
\texttt{logs/counting\_review3.log} (MC counts carrying the framework's full
central-value weight, tune $\times$ PPFX $\times$ normalisation; the earlier count used
the tune alone and sat $3$--$6\%$ higher, and the original unweighted count a further
$0.3$--$0.5\%$ above that).
...
\midrule
    FHC      & $1.03 \pm 0.42$ & $0.82\,(0.5\sigma)$ & $1.13\,(0.2\sigma)$ & $1.32\,(0.7\sigma)$ & $1.25\,(0.5\sigma)$ \\
    RHC      & $0.93 \pm 0.41$ & $0.67\,(0.6\sigma)$ & $0.94\,(0.0\sigma)$ & $1.10\,(0.4\sigma)$ & $1.04\,(0.3\sigma)$ \\
    Combined & $0.98 \pm 0.39$ & $0.74\,(0.6\sigma)$ & $1.03\,(0.1\sigma)$ & $1.20\,(0.6\sigma)$ & $1.14\,(0.4\sigma)$ \\
\bottomrule
\end{tabular}
\end{table}
...
configuration. The RHC detector term is the largest single-configuration entry, reaching $43.1\%$ on
$p_\pi$ and $40.6\%$ on $\cos\theta_\mu$.

\begin{center}\scriptsize
\captionof{table}{FHC (\{Run~1,2,4,5\}) systematic breakdown by source, bin-averaged
  fractional uncertainty (\%), regenerated on 2026-09-02 from the release systematics
  dumps of the 2026-08-31 pass (\texttt{logs/systdump}); ``Prediction total'' excludes
  the data statistics. The previous version of this table predated the detector-variation
  rebuild (detector terms of $\sim10\%$) and is superseded.}
...
Source & $p_\mu$ & $p_\pi$ & $\cos\theta_\mu$ & $\cos\theta_\pi$ & $\theta_{\mu\pi}$ & $\theta_\mu$ \\
\midrule
\textbf{Prediction total} & \textbf{44.4} & \textbf{59.3} & \textbf{53.7} & \textbf{44.7} & \textbf{36.6} & \textbf{33.8} \\
Cross section (GENIE) & 13.9 & 17.9 & 10.6 & 12.8 & 12.2 & 10.0 \\
Flux (PPFX) & 32.2 & 33.5 & 29.9 & 26.2 & 28.2 & 24.0 \\
Detector & 25.6 & 43.0 & 40.6 & 31.5 & 18.5 & 21.0 \\
Reinteraction & 5.1 & 10.7 & 4.7 & 5.9 & 4.2 & 3.4 \\
MC stat & 5.0 & 4.8 & 5.5 & 3.9 & 2.7 & 2.3 \\
EXT stat & 1.4 & 1.6 & 1.4 & 1.0 & 0.7 & 0.7 \\
Data stat & 17.2 & 16.3 & 19.6 & 13.1 & 9.3 & 8.3 \\
POT $+$ targets & 4.3 & 4.8 & 4.2 & 3.7 & 3.9 & 3.3 \\
\textbf{Total (incl.\ data stat)} & \textbf{48.4} & \textbf{61.7} & \textbf{57.6} & \textbf{46.7} & \textbf{37.8} & \textbf{34.9} \\
\bottomrule
\end{tabular}
\end{center}
...
Source & $p_\mu$ & $p_\pi$ & $\cos\theta_\mu$ & $\cos\theta_\pi$ & $\theta_{\mu\pi}$ & $\theta_\mu$ \\
\midrule
\textbf{Prediction total} & \textbf{40.2} & \textbf{52.8} & \textbf{40.1} & \textbf{37.2} & \textbf{35.2} & \textbf{34.4} \\
Cross section (GENIE) & 12.0 & 17.5 & 11.2 & 12.2 & 10.6 & 9.3 \\
Flux (PPFX) & 27.4 & 32.7 & 27.6 & 24.9 & 27.2 & 25.3 \\
Detector & 25.1 & 34.3 & 25.8 & 22.6 & 18.6 & 20.6 \\
Reinteraction & 5.0 & 12.2 & 4.1 & 4.9 & 3.7 & 3.7 \\
MC stat & 4.7 & 4.2 & 3.1 & 3.0 & 2.1 & 2.4 \\
EXT stat & 1.0 & 1.8 & 1.2 & 0.9 & 0.7 & 1.0 \\
Data stat & 14.9 & 13.4 & 10.1 & 9.5 & 6.6 & 7.7 \\
POT $+$ targets & 3.5 & 4.5 & 3.8 & 3.4 & 3.6 & 3.3 \\
\textbf{Total (incl.\ data stat)} & \textbf{43.2} & \textbf{54.6} & \textbf{41.6} & \textbf{38.5} & \textbf{35.8} & \textbf{35.4} \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Superseded numbers.} The ratios in this paragraph were measured on 2026-08-28,
before the detector-variation rebuild and before the fake-data-truth weighting
correction of 2026-09-02. The cut-and-count totals of the current release
(\noteref{Table}{tab:cutcount}) give an RHC/FHC ratio of the injected tune of $0.901$
(inclusive) and $0.878$ (proton-tagged), which is what the unfolded ratios should be
compared with; the $0.785$/$0.779$ below are not reproduced by the current release and
should not be quoted until re-derived.
For the proton-tagged family the measured RHC/FHC ratio was $0.900$. The
corresponding ratio of the fake-data \emph{truth} integrals was $0.785$ and of the
GENIE tune $0.779$ --- two independent model inputs that agreed with each other and
disagreed with the measurement. The deficit is therefore a property of the sample,

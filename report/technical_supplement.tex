...
\noindent\emph{Provenance.} The D'Agostini cross-check of this section was re-evaluated on
the 2026-09-04 release (per-run beam-off, re-thrown fake data); Table~\ref{tab:dagostini}
and the numbers quoted around it are from that run. The closure figures of the other
methods were evaluated on the 2026-08-31 release and not re-run; the comparison they
support is a property of the operators and is unaffected by the re-throw.
...
$29\%$ (FHC), $27\%$ (RHC) and $20\%$ (Combined), equivalently $A_C$ suppresses the
quoted Wiener-SVD integral by $22\%$, $21\%$ and $17\%$, and it varies by $\le0.3\%$
across 1, 2 and 4 iterations. The D'Agostini integral is flat across the five observables
to $0.9\%$ (FHC, $1.017$--$1.026$), $1.0\%$ (RHC, $0.930$--$0.939$) and $0.3\%$
(Combined, $0.972$--$0.975$), against Wiener-SVD spreads of $15\%$, $25\%$ and $17\%$,
...
\begin{table}[H]
  ...
  \caption{Wiener-SVD vs.\ D'Agostini (iterative Bayesian, 4~iterations) integrated
    ...
    the 2026-09-04 release. D'Agostini carries no $A_C$ smearing, so it recovers a
    $20$--$29\%$ higher total, and it is flat across observables (spread $0.9\%$ FHC,
    $1.0\%$ RHC, $0.3\%$ combined) where the Wiener-SVD integrals spread by $15$--$25\%$,
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    FHC      & $0.792$ & $1.021$ & $1.29$ & $\le0.3\%$ \\
    RHC      & $0.733$ & $0.933$ & $1.27$ & $\le0.3\%$ \\
    Combined & $0.809$ & $0.974$ & $1.20$ & $\le0.1\%$ \\
    \bottomrule
  \end{tabular}
\end{table}

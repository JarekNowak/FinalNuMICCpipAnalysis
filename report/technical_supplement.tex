...
$0.02$ and $0.01$ on two bins and unfolded-to-truth integral ratios of $0.997$, $0.981$
and $0.989$ (Tables~\ref{N-tab:fhc}--\ref{N-tab:comb} of the analysis note). The
...
tried; as the two following paragraphs show, the golden-pion
...
\begin{figure}[H]
  ...
  \caption{Muon-angle differential cross section in $\theta_\mu$ (left) and
    ...
    distributions are Figs.~\noteref{Fig.}{fig:dsigma_current}--\noteref{Fig.}{fig:dsigma_comb}

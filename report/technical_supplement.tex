...
Nothing here is superseded by the note; the two are consistent by construction, having
been split from a single source.  Material that \emph{was} superseded --- the
corrections that changed a result --- is recorded separately in the change log, with

...
$1.539$~rad at $0.73$. Both were extracted in all three configurations (Table~\ref{tab:thetap_rhc}).
...
therefore not the best available, and since $\theta_p$ is a new observable and nothing depends on
them yet, the binning should be settled before it is proposed. This is a decision, not a correction:
the cost of the three-bin scheme is one bin of the shape, and its FHC data-statistical term is the
best of the three ($11.2\%$).

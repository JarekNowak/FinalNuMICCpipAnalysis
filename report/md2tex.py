...
FIGSETS = {
 "comparison": ([ (f"plot_{CMP[o]}_0.pdf",
        (r"Unfolded d$\sigma$/d"+OLAB[o]+r" (fake data): four generators $+$ MicroBooNE tune $+$ fake-data truth (all $A_C$-smeared), with data/MC ratio panel."
         if o=="pmu" else r"Unfolded d$\sigma$/d"+OLAB[o]+r".")) for o in OBS], 0.84),

...
{\footnotesize\ttfamily dc0545b \textperiodcentered\ 51 extractions \textperiodcentered\ blind\par}
  ...
  \begin{abstract}
    ...
    realised truth to $0.98$--$0.99$; the RHC/FHC ratio of the injected tune is $0.901$. The Wiener-SVD integrated cross sections are of order
    ...
    %
    Compared with the standalone generators in the same phase space, the one-bin total
    lies $0.5$--$0.8\sigma$ above GENIE~v3 and within $0.8\sigma$ of
...
terms, propagated exactly as for the differential results but without the amplification
that the regularised inversions suffer: the flux term is $28$--$30\%$ here against
$24$--$33\%$ bin-averaged after unfolding, the detector term $20$--$22\%$ against
$16$--$35\%$, and the data-statistical term $3$--$4\%$ ($5$--$7\%$ proton-tagged)
against $6$--$18\%$. Because no additional smearing is applied the total is the physical
...
$0.98$--$1.00$ with $\chi^2/1\ll1$ in all six cases. The uncertainty column is what the
...
one-bin total cross section (Table~\ref{tab:cutcount}). The ten are: the six

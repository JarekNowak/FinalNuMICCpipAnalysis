...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    $W_{\pi p}$        & $0.550$ & $1.12$ & $0.19/6$ \\
    $W_\mathrm{had}$   & $0.500$ & $1.13$ & $0.86/6$ \\
    $\delta p_T$       & $0.482$ & $1.15$ & $1.87/6$ \\
    $\delta\alpha_T$   & $0.551$ & $1.20$ & $0.67/6$ \\
    $\delta\phi_T$     & $0.592$ & $1.17$ & $4.02/6$ \\
    $p_n$              & $0.432$ & $1.00$ & $0.19/6$ \\
    \midrule
    $p_\mu$            & $0.555$ & $1.16$ & $0.54/7$ \\
    $p_\pi$            & $0.596$ & $1.15$ & $0.15/2$ \\
    $\cos\theta_\mu$   & $0.555$ & $1.11$ & $0.18/5$ \\
    $\cos\theta_\pi$   & $0.479$ & $1.13$ & $0.18/4$ \\
    $\theta_{\mu\pi}$  & $0.515$ & $1.14$ & $0.66/5$ \\
  \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    Observable & $\sigma_\mathrm{int}$ & unf./truth & $\chi^2/\mathrm{ndf}$ \\
    \midrule
    $W_{\pi p}$        & $0.515$ & $1.22$ & $3.42/6$ \\
    $W_\mathrm{had}$   & $0.540$ & $1.34$ & $3.02/6$ \\
    $\delta p_T$       & $0.452$ & $1.21$ & $1.16/6$ \\
    $\delta\alpha_T$   & $0.472$ & $1.22$ & $5.12/6$ \\
    $\delta\phi_T$     & $0.596$ & $1.21$ & $1.55/6$ \\
    $p_n$              & $0.464$ & $1.07$ & $3.18/6$ \\
    \midrule
    $p_\mu$            & $0.499$ & $1.23$ & $1.21/7$ \\
    $p_\pi$            & $0.497$ & $1.10$ & $2.36/2$ \\
    $\cos\theta_\mu$   & $0.559$ & $1.28$ & $0.78/5$ \\
    $\cos\theta_\pi$   & $0.474$ & $1.24$ & $4.04/4$ \\
    $\theta_{\mu\pi}$  & $0.465$ & $1.16$ & $0.48/5$ \\
  \bottomrule
  \end{tabular}
\end{table}

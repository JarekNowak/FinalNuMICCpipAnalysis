...
activity) --- are not applied. This raises the efficiency to $15.5\%$ ($2\pi$) and
$6.1\%$ ($3\pi$), a factor of $\sim\!4$ and $\sim\!8$ respectively; the number of selected
signal events on the Run-1 FHC $\nu_\mu$ overlay grows from $\sim\!110$ to $580$ ($2\pi$)
and from $\sim\!1$ to $40$ ($3\pi$), the latter turning $3\pi$ from a non-measurement into
a viable flux-averaged total cross section. A per-pion true-momentum threshold of
$0.10\GeVc$ (the pion tracking turn-on) is applied to all $N$ pions in the signal
definition; the dedicated multi-pion note documents the threshold study.

Table~\ref{tab:cutflow_multipi} gives the cut-flow. The dominant loss is at the
$N$-pion identification stage (MuonCandidate$\rightarrow$ContainedPions: $61\%\!\to\!21\%$
for $2\pi$, $60\%\!\to\!8\%$ for $3\pi$): reconstructing $N$ pion-like tracks is the
...
Feasibility: with $\sim\!580$ selected signal events at full exposure the $2\pi$ channel

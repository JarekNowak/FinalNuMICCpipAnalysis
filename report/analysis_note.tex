...
iteration-stable integral, $23$--$31\%$ above Wiener-SVD (config-dependent), confirms
...
$0.87$--$0.95$ for the first bins of the angular observables, $0.67$--$0.88$ elsewhere in
...
\captionof{table}{Integrated (unfolded) cross section $\sigma_\mathrm{int}$ over the
  ...
  (\suppref{Sec.}{sec:crosschecks}) recovers a flat, $23$--$31\%$ higher total, confirming

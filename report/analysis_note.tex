...
\begin{titlepage}
  ...
  \begin{abstract}
    ...
    (FHC; Runs~1, 2, 4, 5; $8.857\times10^{20}$ $\nu_e$-matched protons on target,
...
\begin{table}[H]
  ...
  \caption{Cut-flow yields at \emph{full exposure} for FHC, RHC and combined
    ...
    POT-scaled per mode; EXT (beam-off cosmic) is scaled by the data/EXT trigger
    ratio (FHC $5.51$, RHC $6.91$, combined $12.41$); dirt from the GENIE NuMI
    dirt overlay. Pred.\ $=$ Signal $+$ Bkg $+$ EXT $+$ Dirt.}
  \label{tab:cutflow}
  \small
  \begin{tabular}{lrrrrr}
    ...
    \textbf{Nonprotons} & \textbf{993} & \textbf{653} & \textbf{121} & \textbf{1.3} & \textbf{1\,768} \\
    \midrule
    ...
    \textbf{Nonprotons} & \textbf{1\,084} & \textbf{747} & \textbf{152} & \textbf{1.0} & \textbf{1\,985} \\
    \midrule
    ...
    \textbf{Nonprotons} & \textbf{2\,077} & \textbf{1\,400} & \textbf{273} & \textbf{1.3} & \textbf{3\,752} \\
    \bottomrule
  \end{tabular}
\end{table}

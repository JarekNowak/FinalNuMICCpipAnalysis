...
{\footnotesize\ttfamily d5c929d \textperiodcentered\ 51 extractions \textperiodcentered\ blind\par}
  ...
  \begin{abstract}
    ...
    unfolding in six kinematic variables: muon momentum~$\pmuM$, pion
    momentum~$\ppiM$, muon polar angle~$\cthmuM$, pion polar angle~$\cthpiM$,
    the muon--pion opening angle~$\thmupM$, and the muon polar angle in
      its $\theta$ parameterisation.
    %
...
RHC & $\theta_\mu$       & $0.84/5$ & $1.48/5$ & $2.39/5$ & $2.21/5$ & $9.17/5$ & $9.65/5$ \\
\midrule
Comb & $\cos\theta_\mu$   & $0.20/5$ & $0.53/5$ & $0.82/5$ & $0.61/5$ & $4.55/5$ & $4.48/5$ \\
Comb & $\theta_\mu$       & $0.76/5$ & $0.51/5$ & $2.51/5$ & $3.87/5$ & $10.19/5$ & $10.33/5$ \\
\bottomrule
  \end{tabular}
\end{table}
...
Observable & $\sigma_\mathrm{int}$ & Flux & Detector & Total & Closure $\chi^2/\mathrm{ndf}$ \\
      \midrule
      $p_\mu$            & $0.828$ & $28.1\%$ & $25.0\%$ & $41.1\%$ & $0.10/7$ ($p=1.00$) \\
      $p_\pi$            & $0.855$ & $31.0\%$ & $28.8\%$ & $48.1\%$ & $0.10/2$ ($p=0.95$) \\
      ...
      $\theta_\mu$       & $0.846$ & $26.7\%$ & $16.9\%$ & $33.8\%$ & $0.72/5$ ($p=0.98$) \\
      \bottomrule
\end{tabular}
\end{center}
...
Observable & $\sigma_\mathrm{int}$ & Flux & Detector & Total & Closure $\chi^2/\mathrm{ndf}$ \\
      \midrule
      $p_\mu$            & $0.575$ & $31.9\%$ & $25.7\%$ & $44.5\%$ & $1.72/7$ ($p=0.97$) \\
      $p_\pi$            & $0.763$ & $33.4\%$ & $42.8\%$ & $59.3\%$ & $0.24/2$ ($p=0.89$) \\
      ...
      $\theta_\mu$       & $0.839$ & $24.0\%$ & $21.2\%$ & $34.1\%$ & $0.84/5$ ($p=0.97$) \\
      \bottomrule
\end{tabular}
\end{center}
...
Observable & $\sigma_\mathrm{int}$ & Flux & Detector & Total & Closure $\chi^2/\mathrm{ndf}$ \\
      \midrule
      $p_\mu$            & $0.723$ & $27.5\%$ & $25.3\%$ & $40.6\%$ & $0.67/7$ ($p=1.00$) \\
      $p_\pi$            & $0.799$ & $32.6\%$ & $34.2\%$ & $52.9\%$ & $0.26/2$ ($p=0.88$) \\
      ...
      $\theta_\mu$       & $0.842$ & $25.0\%$ & $20.4\%$ & $34.1\%$ & $0.76/5$ ($p=0.98$) \\
      \bottomrule
\end{tabular}
\end{center}
...
FHC band ($0.43$--$0.57$), as expected for the $\bar\nu_\mu$-enriched RHC flux; and
...
results tables and the data release, and covers all eleven combined proton-tagged observables.
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
      ...
      $W_\mathrm{had}$   & $0.483$ & $1.21$ & $2.52/6$ \\
      $\delta p_T$       & $0.513$ & $1.08$ & $0.05/2$ \\
      $\delta\alpha_T$   & $0.529$ & $1.05$ & $0.12/2$ \\
      $\delta\phi_T$     & $0.517$ & $1.07$ & $0.26/2$ \\
      $p_n$              & $0.555$ & $1.10$ & $0.21/2$ \\
      \midrule
      $p_\mu$            & $0.514$ & $1.08$ & $0.60/7$ \\
      $p_\pi$            & $0.565$ & $1.10$ & $0.11/2$ \\
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
      ...
      $W_\mathrm{had}$   & $0.398$ & $1.15$ & $1.21/6$ \\
      $\delta p_T$       & $0.425$ & $1.07$ & $0.08/2$ \\
      $\delta\alpha_T$   & $0.487$ & $1.17$ & $0.24/2$ \\
      $\delta\phi_T$     & $0.442$ & $1.10$ & $0.06/2$ \\
      $p_n$              & $0.456$ & $1.11$ & $0.06/2$ \\
      \midrule
      $p_\mu$            & $0.428$ & $1.15$ & $0.24/7$ \\
      $p_\pi$            & $0.433$ & $1.05$ & $0.66/2$ \\
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
      ...
      $W_\mathrm{had}$   & $0.428$ & $1.19$ & $3.24/6$ \\
      $\delta p_T$       & $0.513$ & $1.03$ & $0.06/2$ \\
      $\delta\alpha_T$   & $0.507$ & $1.09$ & $0.06/2$ \\
      $\delta\phi_T$     & $0.474$ & $1.00$ & $0.15/2$ \\
      $p_n$              & $0.494$ & $1.09$ & $0.11/2$ \\
      \midrule
      $p_\mu$            & $0.487$ & $1.12$ & $0.43/7$ \\
      $p_\pi$            & $0.497$ & $1.08$ & $0.12/2$ \\
...
FHC and RHC values for all eleven observables.  Earlier drafts reported four exceptions,
...
The spread across observables within a configuration, $0.41$ to $0.51$ for the combined
...
\begin{table}[H]
  \centering
    ...
    \begin{tabular}{L{3.4cm} L{3.4cm} c c}
      ...
      \midrule
      Flux (PPFX multisims)   & \texttt{weightsFlux}  & $24.0$--$33.4$ & $19.5$--$35.5$ \\
      Detector response       & Dedicated samples     & $16.9$--$42.7$ & $10.5$--$64.4$ \\
      Cross-section model     & \texttt{weightsGenie} & $9.1$--$17.8$  & $7.2$--$22.8$ \\
      Hadron re-interaction   & \texttt{weightsReint} & $3.4$--$12.1$  & $3.0$--$15.6$ \\
      ...
      \midrule
      \textbf{Prediction total} & quadrature sum    & $\mathbf{33.8}$--$\mathbf{59.3}$ & $\mathbf{24.3}$--$\mathbf{77.2}$ \\
      \textbf{Total}            & incl.\ data stats & $\mathbf{35.2}$--$\mathbf{61.7}$ & $\mathbf{26.1}$--$\mathbf{86.2}$ \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{L{4.5cm} L{2.5cm} L{5.0cm}}
    ...
    Beam-on signal region not opened
      & \textbf{By design}
      & Blind analysis.  The fake data are thrown at the full per-run data exposure
        already, so no exposure increase is pending; what unblinding adds is the real
        data vector, not more POT \\[4pt]
    Generator comparisons (GENIE, NuWro, NEUT, GiBUU)
      & \textbf{Resolved}
      & All four are extracted and compared for every observable
        (Table~\ref{tab:chi2_incl}), with a single application of $A_C$ \\[4pt]
...
\paragraph{\texorpdfstring{FHC $\theta_\mu$: a rank-1 collapse, since repaired.}{FHC theta-mu: a rank-1 collapse, since repaired.}}
Under the original uniform-grid regularisation the additional-smearing matrix for FHC
$\theta_\mu$ was rank-1 to numerical precision --- its second singular value was
$2.8\times10^{-6}$ of the first, against $\sim\!5\times10^{-2}$ for the inputs --- so every
model and the data were mapped onto a single curve and agreed by construction.

The width-aware operator repairs it: $s_2/s_1$ is now $0.51$ for FHC $\theta_\mu$ and
$0.38$ for the combined configuration, and the observable discriminates between models
again, preferring the tune that generated the fake data.  The conclusion drawn from the
collapsed state --- that $\theta_\mu$ repairs what $A_C$ does to $\cos\theta_\mu$ ---
remains withdrawn, but for the opposite reason to the one first given: the two
parameterisations are now comparably conditioned, and neither is privileged.
...
reaches $\approx\!15.6\%$ efficiency at $\approx\!55\%$ purity.  Angles and transverse
...
extractions is $1.001$ with second-derivative regularisation and $1.007$ with the identity.
...
The upper edge of the top $p_\pi$ bin is the kinematic limit of the sample rather than a
chosen boundary: that bin is an inclusive high-momentum region, not a differential point,
for the reasons set out in the technical supplement.

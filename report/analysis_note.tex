...
integrated-cross-section ratios ($0.96$--$1.08$) reflect the same non-norm-preserving
Wiener-SVD additional smearing $A_C$ seen in the inclusive measurement
(\suppref{Sec.}{sec:crosschecks}), largest for $\cos\theta_\mu$ and $p_\mu$. The
...
$\sigma_\mathrm{int}$ clustered in $0.31$--$0.44\times10^{-38}$~cm$^2$/Ar, below the
FHC band ($0.39$--$0.50$), as expected for the $\bar\nu_\mu$-enriched RHC flux; and

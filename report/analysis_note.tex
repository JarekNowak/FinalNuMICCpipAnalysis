...
\paragraph{A residual in the proton-tagged family.}
The proton-tagged samples are thrown by the same machinery into a separate
directory and carry a smaller double-weighting factor ($1.028$ for FHC). Removing
it moves their closure from $\approx\!1.15$ to $1.053$ (FHC), $1.118$ (RHC) and
$1.100$ (combined) --- an improvement, but not to unity. Whatever remains there is
specific to that selection and is not the effect described above.

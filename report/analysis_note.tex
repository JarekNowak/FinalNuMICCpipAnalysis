...
{\footnotesize\ttfamily dc0545b \textperiodcentered\ 51 extractions \textperiodcentered\ blind\par}
  ...
  \begin{abstract}
    ...
    ($20$--$29\%$ above Wiener-SVD, and flat to $\le1.0\%$ across observables where the
      Wiener-SVD spread is $15$--$25\%$; re-evaluated on this release)
      confirms that the
...
iteration-stable integral, $20$--$29\%$ above Wiener-SVD (config-dependent), confirms

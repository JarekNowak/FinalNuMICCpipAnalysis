...
\begin{table}[H]
  ...
  \begin{tabular}{lcccc}
    ...
    RHC      & $1.02$ & $1.39$ & $1.37$ & $<1\%$ \\
    Combined & $0.94$ & $1.30$ & $1.38$ & $<1\%$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
overlaid with all four generator predictions (GENIE, GiBUU, NEUT, NuWro) for the same
proton-tagged phase space (shown at the analysis binning; the finer-binning montage is in
preparation). The predictions are built at truth level from each

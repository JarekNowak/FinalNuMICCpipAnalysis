...
which points at model dependence in the unfolding rather than an algorithmic bias.
That is a hypothesis, not a demonstration: it predicts the offset should scale with
the NuWro/\textsc{Genie} disagreement in each observable, which has not been tested.

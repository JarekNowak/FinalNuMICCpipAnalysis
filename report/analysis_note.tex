...
\begin{itemize}\itemsep1pt \setlength{\parskip}{0pt}
  ...
  \item \textbf{Validated:} the implementation, the size of the statistical uncertainties, and
    robustness to a reweighted interaction model (a model-distortion closure with GENIE reweighting; an independent-generator closure is still pending) --- no bin biased by more than

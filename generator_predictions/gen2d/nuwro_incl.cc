// gen2d copy of costhpi5/nuwro_cc1pi_c5.cc (2026-09-16): unchanged except for the added ext:: fills of obs_ext.h
...
// 5-bin theta_mu-pi edges; otherwise identical to ppi2bin/nuwro_cc1pi_2bin.cc
// nuwro_cc1pi.cc
...
static const std::vector<double> EDGES_PMU = {0.150,0.350,0.550,0.750,0.950,1.250,1.750,99.0};
...
static const std::vector<double> EDGES_COSTHPI = {-1.0,-0.10,0.35,0.60,0.80,1.0};
static const std::vector<double> EDGES_THMUPI = {0.0,0.60,0.85,1.30,1.85,2.60};

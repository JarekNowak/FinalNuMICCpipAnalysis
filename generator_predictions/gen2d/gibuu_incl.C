// gen2d copy of costhpi5/gibuu_cc1pi_c5.C (2026-09-16): unchanged except for the added ext:: fills of obs_ext.h
...
// 5-bin theta_mu-pi edges; otherwise identical to ppi2bin/gibuu_cc1pi_2bin.C
...
#include "obs_ext.h"
void gibuu_incl(const char* infile, double num_runs, const char* outfile){
  ...
  hpmu->Write();hppi->Write();hcmu->Write();hcpi->Write();hth->Write(); for(auto* hh:X.all) hh->Write(); fo.Close();

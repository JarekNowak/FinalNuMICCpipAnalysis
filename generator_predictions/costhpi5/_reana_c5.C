{ gSystem->AddIncludePath("-I/home/t2k/nowak/generators/neut/src/neutclass");
  ...
  gROOT->ProcessLine(".L neut_cc1pi_c5.C+");
  gROOT->ProcessLine("neut_cc1pi_c5(\"../newg4/neut/neutvect_numu.root\",\"neut_c5_numu.root\")");
  gROOT->ProcessLine("neut_cc1pi_c5(\"../newg4/neut/neutvect_numubar.root\",\"neut_c5_numubar.root\")"); }

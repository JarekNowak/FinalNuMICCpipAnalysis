...
*/
  ...
  Block1D* b2t = new Block1D( "CC1mu1p0pi_TrueMomentum_GeV",
    "p_{#mu}; (GeV)", "p_{\\mu}; (GeV)", pmu_1D_edges,
    "CC1mu1p0pi_MC_Signal", kSignalTrueBin );

  Block1D* b2r = new Block1D( "CC1mu1p0pi_CandidateMuMom.Mag()",
    "p_{#mu}; (GeV)", "p_{\\mu}; (GeV)", pmu_1D_edges,
    "CC1mu1p0pi_Selected", kOrdinaryRecoBin );

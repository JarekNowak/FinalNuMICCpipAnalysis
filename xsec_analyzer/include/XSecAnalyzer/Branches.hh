...
inline void SetBranchAddress(TTree& etree, std::string BranchName, void* Variable) {
...
inline void set_event_branch_addresses(TTree& etree, AnalysisEvent& ev)
{
 ...
 // SetBranchAddress(etree, "candidate_muon_mom_mcs", &ev.candidate_muon_mom_mcs);
 // SetBranchAddress(etree, "candidate_muon_mom_true", &ev.candidate_muon_mom_true);
...
inline void set_event_output_branch_addresses(TTree& out_tree, AnalysisEvent& ev,
  bool create = false)
{

...
std::cout <<"slice plots test 1 "<< std::endl;
...
std::cout <<"slice plots test 2 "<< std::endl;
...
std::cout <<"slice plots test 3 "<< std::endl;
...
std::cout<<"it is mcc9syst " << std::endl;
...
std::cout <<"slice plots test 4 "<< std::endl;
...
std::cout <<"slice plots test 5 "<< std::endl;
...
std::cout<< " test 5b " <<std::endl;


  auto& matrix_map = *matrix_map_ptr;

std::cout<< " test 5c " << std::endl;


  auto* sb_ptr = new SliceBinning( SLICE_Config );

std::cout<< " test 5d " << std::endl;

  auto& sb = *sb_ptr;

std::cout<< " test 5e " << std::endl;


   // for ( size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx ) {       //changed here
    for ( size_t sl_idx = 1u; sl_idx < 2u; ++sl_idx ) {

    const auto& slice = sb.slices_.at( sl_idx );

std::cout <<" now it works here "<<std::endl;
...
//std::cout <<"slice plots test 6 "<< std::endl;
...
//std::cout <<"slice plots test 7 "<< std::endl;
...
//std::cout <<"slice plots test 8 "<< std::endl;
...
//std::cout <<"slice plots test 9 "<< std::endl;
...
//std::cout <<"slice plots test 10 "<< std::endl;
...
//std::cout <<"slice plots test 11 "<< std::endl;
...
//std::cout <<"slice plots test 12 "<< std::endl;
...
std::cout <<"slice plots test 13 "<< std::endl;
...
std::cout <<"slice plots test 14 "<< std::endl;

...
*/
  ...
  Block1D* b2t = new Block1D( "CC1mu1piXp_candidate_muon_mom_true",
    "p_{#mu}; (GeV)", "p_{\\mu}; (GeV)", pmu_1D_edges,
    "CC1mu1piXp_MC_Signal", kSignalTrueBin );

  Block1D* b2r = new Block1D( "CC1mu1piXp_candidate_muon_mom_mcs",
    "p_{#mu}; (GeV)", "p_{\\mu}; (GeV)", pmu_1D_edges,
    "CC1mu1piXp_Selected", kOrdinaryRecoBin );

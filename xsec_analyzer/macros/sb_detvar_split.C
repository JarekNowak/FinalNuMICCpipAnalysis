...
#include <string>
#include <cmath>
void sb_detvar_split(const char* mode="fhc"){
  ...
  const int NC=6; TString cls[NC]; const char* cln[NC]={"all nu-MC","signal","numuCC 0pi","numuCC pi0 (any)","numuCC >=2pi+-, no pi0","OOFV+NC+nueCC"};

...
void sb_transfer_unc_pf(const char* mode="fhc"){
  ...
  const char* creg[NT]={"CC1mu1piXp_sb_cc0pi","CC1mu1piXp_sb_multipi","CC1mu1piXp_sb_pi0_final","CC1mu1piXp_sb_cc0pi","CC1mu1piXp_sb_pi0_final"};
  ...
  for(auto& x:mc){
    ...
    t->Draw(">>el","CC1mu1piXp_Selected||CC1mu1piXp_sb_cc0pi||CC1mu1piXp_sb_multipi||CC1mu1piXp_sb_pi0_final","entrylist"); TEntryList* el=(TEntryList*)gDirectory->Get("el");
